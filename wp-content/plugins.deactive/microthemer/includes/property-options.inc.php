...
$propertyOptions['shadow']['box_shadow_blur'] = array(
	'sh' => array('box-shadow', 2, array(
		'onlyShort' => 1,
		'initial' => 0 // required (for MT) otherwise spread can be interpreted as blur
	)),
	'short_label' => esc_html_x('Blur', 'noun', 'microthemer'),
...
$propertyOptions['grid']['grid_auto_flow'] = array(
	'sh' => array(
		array('grid', 5, array('initial' => 'none')),
	),
...
// column-gap
$propertyOptions['grid']['column_gap'] = array(
...
// row-gap
$propertyOptions['grid']['row_gap'] = array(
