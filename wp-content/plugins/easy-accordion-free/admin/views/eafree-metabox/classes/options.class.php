...
if ( ! class_exists( 'SP_EAP_Options' ) ) {
	class SP_EAP_Options extends SP_EAP_Abstract {
		...
		public $args = array(
			...
			// framework title.
			'framework_title'         => 'SPF Framework <small>by Codestar</small>',
			'framework_class'         => '',
		...
		public function add_options_html() {
			...
			echo ( $has_nav && $this->args['show_all_options'] ) ? '<div class="spf-expand-all" title="' . esc_html__( 'show all options', 'easy-accordion-free' ) . '"><i class="fa fa-outdent"></i></div>' : '';

			echo ( $this->args['show_search'] ) ? '<div class="spf-search"><input type="text" placeholder="' . esc_html__( 'Search option(s)', 'easy-accordion-free' ) . '" /></div>' : '';

			echo '<div class="spf-buttons">';
			echo '<input type="submit" name="' . $this->unique . '[_nonce][save]" class="button button-primary spf-save' . $ajax_class . '" value="' . esc_html__( 'Save', 'easy-accordion-free' ) . '" data-save="' . esc_html__( 'Saving...', 'easy-accordion-free' ) . '">';
			echo ( $this->args['show_reset_section'] ) ? '<input type="submit" name="spf_transient[reset_section]" class="button button-secondary spf-reset-section spf-confirm" value="' . esc_html__( 'Reset Section', 'easy-accordion-free' ) . '" data-confirm="' . esc_html__( 'Are you sure to reset this section options?', 'easy-accordion-free' ) . '">' : '';
			echo ( $this->args['show_reset_all'] ) ? '<input type="submit" name="spf_transient[reset]" class="button button-secondary spf-warning-primary spf-reset-all spf-confirm" value="' . esc_html__( 'Reset All', 'easy-accordion-free' ) . '" data-confirm="' . esc_html__( 'Are you sure to reset all options?', 'easy-accordion-free' ) . '">' : '';
			echo '</div>';
				...
				if ( ! empty( $section['fields'] ) ) {
					...
					foreach ( $section['fields'] as $field ) {
						...
						SP_EAP::field( $field, $value, $this->unique, 'options' );
								  ...
								  echo '<div class="spf-no-option spf-text-muted">' . esc_html__( 'No option provided by developer.', 'easy-accordion-free' ) . '</div>';
			...
			if ( ! empty( $this->args['show_footer'] ) ) {
				...
				echo '<div class="spf-buttons">';
				echo '<input type="submit" name="spf_transient[save]" class="button button-primary spf-save' . $ajax_class . '" value="' . esc_html__( 'Save', 'easy-accordion-free' ) . '" data-save="' . esc_html__( 'Saving...', 'easy-accordion-free' ) . '">';
				echo ( $this->args['show_reset_section'] ) ? '<input type="submit" name="spf_transient[reset_section]" class="button button-secondary spf-reset-section spf-confirm" value="' . esc_html__( 'Reset Section', 'easy-accordion-free' ) . '" data-confirm="' . esc_html__( 'Are you sure to reset this section options?', 'easy-accordion-free' ) . '">' : '';
				echo ( $this->args['show_reset_all'] ) ? '<input type="submit" name="spf_transient[reset]" class="button button-secondary spf-warning-primary spf-reset-all spf-confirm" value="' . esc_html__( 'Reset All', 'easy-accordion-free' ) . '" data-confirm="' . esc_html__( 'Are you sure to reset all options?', 'easy-accordion-free' ) . '">' : '';
				echo '</div>';
