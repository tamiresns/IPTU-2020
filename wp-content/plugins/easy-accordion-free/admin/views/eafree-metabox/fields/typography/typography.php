	...
	class SP_EAP_Field_typography extends SP_EAP_Fields {
		...
		public function render() {
			...
			if ( ! empty( $args['font_family'] ) ) {
				...
				echo '<div class="spf--title">' . esc_html__( 'Font Family', 'easy-accordion-free' ) . '</div>';
				echo '<select disabled name="sp_eap_shortcode_options[eap_section_title_typography][font-family]" class="spf--font-family" data-placeholder="Select a font" style="display: none;">
			...
			if ( ! empty( $args['backup_font_family'] ) ) {
				...
				echo '<div class="spf--title">' . esc_html__( 'Backup Font Family', 'easy-accordion-free' ) . '</div>';
			...
			if ( ! empty( $args['font_weight'] ) || ! empty( $args['font_style'] ) ) {
				...
				echo '<div class="spf--title">' . esc_html__( 'Font Style', 'easy-accordion-free' ) . '</div>';
				echo '<select disabled class="spf--font-style-select" data-placeholder="Default">';
				echo '<option disabled value="">' . ( ! $this->chosen ? esc_html__( 'Default', 'easy-accordion-free' ) : '' ) . '</option>';
				...
				if ( ! empty( $args['extra_styles'] ) ) {
					...
					echo ( ! $this->chosen ) ? '<div class="spf--title">' . esc_html__( 'Load Extra Styles', 'easy-accordion-free' ) . '</div>' : '';
			...
			if ( ! empty( $args['subset'] ) ) {
				...
				echo '<div class="spf--title">' . esc_html__( 'Subset', 'easy-accordion-free' ) . '</div>';
			...
			if ( ! empty( $args['font_variant'] ) ) {
				echo '<div class="spf--block">';
				echo '<div class="spf--title">' . esc_html__( 'Font Variant', 'easy-accordion-free' ) . '</div>';
				echo $this->create_select(
					array(
			...
			if ( ! empty( $args['text_transform'] ) ) {
				echo '<div class="spf--block">';
				echo '<div class="spf--title">' . esc_html__( 'Text Transform', 'easy-accordion-free' ) . '</div>';
			...
			if ( ! empty( $args['text_decoration'] ) ) {
				echo '<div class="spf--block">';
				echo '<div class="spf--title">' . esc_html__( 'Text Decoration', 'easy-accordion-free' ) . '</div>';
				echo $this->create_select(
					array(
			...
			if ( ! empty( $args['font_size'] ) ) {
				echo '<div class="spf--block">';
				echo '<div class="spf--title">' . esc_html__( 'Font Size', 'easy-accordion-free' ) . '</div>';
			...
			if ( ! empty( $args['line_height'] ) ) {
				echo '<div class="spf--block">';
				echo '<div class="spf--title">' . esc_html__( 'Line Height', 'easy-accordion-free' ) . '</div>';
				echo '<div class="spf--blocks">';
			...
			if ( ! empty( $args['letter_spacing'] ) ) {
				echo '<div class="spf--block">';
				echo '<div class="spf--title">' . esc_html__( 'Letter Spacing', 'easy-accordion-free' ) . '</div>';
				echo '<div class="spf--blocks">';
			...
			if ( ! empty( $args['word_spacing'] ) ) {
				echo '<div class="spf--block">';
				echo '<div class="spf--title">' . esc_html__( 'Word Spacing', 'easy-accordion-free' ) . '</div>';
				echo '<div class="spf--blocks">';
			...
			if ( ! empty( $args['color'] ) ) {
				...
				echo '<div class="spf--title">' . esc_html__( 'Font Color', 'easy-accordion-free' ) . '</div>';
				...
				if ( ! empty( $args['hover_color'] ) ) {
					...
					echo '<div class="spf--block spf--block-font-color">';
					echo '<div class="spf--title">' . esc_html__( 'Font Hover Color', 'easy-accordion-free' ) . '</div>';
					echo '<div class="spf-field-color">';
					echo '<input type="text" disabled name="' . $this->field_name( '[hover_color]' ) . '" class="spf-color spf--color" value="' . $this->value['hover_color'] . '"' . $default_hover_color_attr . ' />';
					echo '</div>';
					echo '</div>';
				}
				//
				...
				if ( ! empty( $args['active_color'] ) ) {
					$default_active_color_attr = ( ! empty( $default_value['active_color'] ) ) ? ' data-default-color="' . $default_value['active_color'] . '"' : '';
					echo '<div class="spf--block spf--block-font-color">';
					echo '<div class="spf--title">' . esc_html__( 'Font Active Color', 'easy-accordion-free' ) . '</div>';
					echo '<div class="spf-field-color">';
					echo '<input type="text" disabled  name="' . $this->field_name( '[active_color]' ) . '" class="spf-color spf--color" value="' . $this->value['active_color'] . '"' . $default_active_color_attr . ' />';
					echo '</div>';
					echo '</div>';
				}
			...
			if ( ! empty( $args['custom_style'] ) ) {
				...
				echo '<div class="spf--title">' . esc_html__( 'Custom Style', 'easy-accordion-free' ) . '</div>';
				echo '<textarea disabled name="' . $this->field_name( '[custom-style]' ) . '" class="spf--custom-style">' . $this->value['custom-style'] . '</textarea>';
				echo '</div>';
			}
