 ...
 * @version 1.0.0
 */
if ( ! class_exists( 'WP_Customize_Panel_SP_EAP' ) && class_exists( 'WP_Customize_Panel' ) ) {
	class WP_Customize_Panel_SP_EAP extends WP_Customize_Panel {
		public $type = 'spf';
	}
}
 ...
 * @version 1.0.0
 */
if ( ! class_exists( 'WP_Customize_Section_SP_EAP' ) && class_exists( 'WP_Customize_Section' ) ) {
	class WP_Customize_Section_SP_EAP extends WP_Customize_Section {
		public $type = 'spf';
	}
}
 ...
 * @version 1.0.0
 */
if ( ! class_exists( 'WP_Customize_Control_SP_EAP' ) && class_exists( 'WP_Customize_Control' ) ) {
	class WP_Customize_Control_SP_EAP extends WP_Customize_Control {
		...
		public function render_content() {
			...
			SP_EAP::field( $this->field, $this->value(), $this->unique, 'customize' );
